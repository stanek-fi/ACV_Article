...
#' @param method Can be set to either `"augmented"` for the estimator which optimally utilizes also the in-sample performance or `"regular"` for the conventional loss estimator.
